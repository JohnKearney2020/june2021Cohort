...
// Sessions - needs to come after cookieParser
// cookies are stored on the client. Sessions are stored on the server. 
// The session cookie only contains an encrypted string tied to the session. It doesn't store user information or anything identifying like that.
// this will add a session object onto the request object
app.use(
  session({ 
